...
class IMU extends APIBase {
     ...
     */
    void setIMUConfig(boolean compassEnabled, boolean gyroscopeEnabled, boolean accelerometerEnabled) {
     ...
     */
    IMUDataRaw getAccelerometerRaw() {
